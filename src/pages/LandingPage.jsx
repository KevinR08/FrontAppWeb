        ...
        <>
            ...
            <div className="cardVideo">
                <video controls  className="video" ref={handleVideoClick}>
                    <source src="https://firebasestorage.googleapis.com/v0/b/carstore-69599.appspot.com/o/files%2FvideoLandingPage.mp4?alt=media&token=e791c35a-fa85-4fcf-b7c6-c37802c4bf7b" type="video/mp4" />
                    Tu navegador no soporta la etiqueta de video HTML5.
                </video>
                <div className="descripcion">
                    <h3>Rust-eze: Automóviles de Calidad</h3>
                    <h4>En Rust-eze, estamos comprometidos a brindarte una experiencia excepcional en la compra de automóviles. Nos enorgullecemos de ofrecer una amplia gama de vehículos de calidad que se adaptan a cada estilo de vida y necesidad.</h4>
