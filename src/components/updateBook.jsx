...
export default function UpdateBook({ book }) {
  ...
  para actualizar el auto en la base de datos.
  ...
  useEffect(() => {
    if (isSaved) {
      successToast('El auto se actualizó correctamente.');
  ...
  return (
    ...
    <div className="create-book">
      ...
      <label className="checkbox-container">
        ...
        <span className="checkmark-text">Garantizo que soy el titular del auto</span>
      </label>
